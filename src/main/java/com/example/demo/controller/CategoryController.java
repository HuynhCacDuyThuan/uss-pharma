...
public class CategoryController {
 ...
 public ResponseEntity<Category> addSubCategory(
     @RequestPart("category") String categoryJson,  // category as JSON string
    ...
    public ResponseEntity<CategoryDTO> getCategoryById(@PathVariable Long subCategoryId) {
        ...
        CategoryDTO categoryDTO = new CategoryDTO(category.getId(), category.getName(), category.getParentCategory() != null ? category.getParentCategory().getId() : null);
    ...
    public ResponseEntity<CategoryDTO> updateCategory(
        ...
        // Since we don't need to update parentCategory, we skip the logic for parentCategory
        ...
        if (existingCategory != null && !existingCategory.getId().equals(subCategoryId)) {
            ...
            throw new IllegalArgumentException("Category with name '" + subCategoryData.getName() + "' already exists.");
        }
        ...
        if (image != null && !image.isEmpty()) {
            // Save the new image and update the category entity with the new image URL or path
        ...
        CategoryDTO categoryDTO = new CategoryDTO(updatedCategory.getId(), updatedCategory.getName(), updatedCategory.getImageUrl());
    ...
    private String saveImage(MultipartFile image) throws IOException {
        ...
        // Generate a unique filename for the image based on timestamp and original filename
