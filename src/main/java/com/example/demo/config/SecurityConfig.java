	    ...
	    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
	        http.csrf().disable()
	            .authorizeRequests(authorizeRequests -> 
	                authorizeRequests
	                    .requestMatchers("/san-pham/","/api/banners/**","/lien-he/#breadcrumb","/api/logo/**","/api/comments/**","/quen-mat-khau", "/chi-tiet-san-pham/**","/san-pham/**","/chi-tiet-bai-viet/**","/tin-tuc/**","/quan-ly-tin-tuc/**", "/chi-tiet-tin-tuc","/api/news/**","/tin-tuc/","/api/news/add","/them-bai-viet" ,"/admin/news" ,"/api/jobs", "/api/jobs/**", "/admin/job","/api/categories","/dang-nhap","/" , "/lien-he/**" ,"/gioi-thieu/","/dang-ki","/api/products/**",  "/auth/register", "/auth/login", "/css/**", "/fragments/**", "/js/**", "/images/**" , "/js/**","/assets/**", "/fonts/**","/libs/**","/scss/**","/tasks/**", "/loadImage**","/product-details" ,"/tuyen-dung/**" , "/api/submit-contact" , "/details/**","/api/categories/add-subcategory" ,"/product/**", "/loadImage")
	                    .permitAll()
